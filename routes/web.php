...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware('permission:calificaciones.ver')->group(function () {
    ...
    Route::middleware('permission:calificaciones.capturar')->group(function () {
    ...
    Route::middleware('permission:avisos.crear')->group(function () {
    ...
    Route::patch('reportes/{reporte}/firmar', [FirmaController::class, 'firmarReporte'])->name('reportes.firmar');
    Route::patch('avisos/{aviso}/firmar', [FirmaController::class, 'firmarAviso'])->name('avisos.firmar');

    // Portal de padres
    Route::middleware('permission:portal.ver')->group(function () {
    ...
    Route::patch('citas/{cita}/estatus', [CitaController::class, 'actualizarEstatus'])
        ->middleware('permission:citas.gestionar')->name('citas.estatus');

    // Auditoría / bitácora
    Route::middleware('permission:bitacora.ver')->group(function () {
